...
if($_REQUEST['action'] === 'index'){
  ...
  $new_date = new Date(null, $body_object->moviename, $body_object->moviedate, $body_object->moviesnack, $body_object->movieposter); //create a new Person from $body_object
  ...
  echo json_encode($all_dates);
    ...
    $updated_date = new Date($_REQUEST['id'], $body_object->moviename, $body_object->moviedate, $body_object->moviesnack, $body_object->movieposter);
